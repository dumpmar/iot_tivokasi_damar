...
const char* ssid = "Infinix NOTE 40S";
const char* password = "aleganteng";
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    HTTPClient http;
    String url = "http://7c62-175-45-190-255.ngrok-free.app/api/posts"; // Ganti dengan URL ngrok yang benar
